...
556677 Details:
556677 chinni chinni@.com Fe
098890Details:
098890rohith rohith@.com m
............
After Sorted:
098890Details:
098890rohith rohith@.com m
	...
	public class TestCompare {
		...
		public static void main(String[] args) {
			...
			case 1:
				...
				set.add(new Options(1,23000,"Rohith","A"));
				set.add(new Options(2,32000,"NIHA","C"));
				set.add(new Options(3,13000,"NIHARIKA","F"));
			...
			case 2:
				...
				setN.add(new Options(1,23000,"Rohith","A"));
				setN.add(new Options(2,32000,"NIHA","C"));
				setN.add(new Options(3,13000,"NIHARIKA","F"));
			...
			case 3:
				...
				setD.add(new Options(1,23000,"Rohith","A"));
				setD.add(new Options(2,32000,"NIHA","C"));
				setD.add(new Options(3,13000,"NIHARIKA","F"));
			...
			case 4:
				...
				setS.add(new Options(1,23000,"Rohith","A"));
				setS.add(new Options(2,32000,"NIHA","C"));
				setS.add(new Options(3,13000,"NIHARIKA","F"));
